    ...
    <div class="col-md-4">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <pre class="mt-2 d-none" id="payInstructions" style="white-space:pre-wrap"></pre>
        </div>
      </div>
      @else
  ...
  (function(){
    ...
    btn.addEventListener('click', function(){
      ...
      .then(function(r){
        ...
        if(r.data.instructions){ instr.textContent = r.data.instructions; instr.classList.remove('d-none'); msg.textContent='Follow the instructions below.'; btn.disabled=false; return; }
